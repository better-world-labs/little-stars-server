...
func (s *storage) CreateOrUpdateWithSession(session *xorm.Session, evi entities.Evidence) error {
	now := time.Now()
...
func (s *storage) GetOneByBusinessKeyWithSession(session *xorm.Session, category entities.EvidenceCategory, businessKey string) (*entities.Evidence, bool, error) {
...
func (s *storage) GetByUUID(session *xorm.Session, uuid string) (*entities.Evidence, bool, error) {
	var evi entities.Evidence
