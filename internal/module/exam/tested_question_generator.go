...
func (q *testedQuestionGenerator) Generate(projectID int64, userID int64, examType int) ([]*domains.Question, error) {
	//TODO 针对模拟考试详细制定出题策略
...
func (q *testedQuestionGenerator) DoGenerateForMock(questions []*domains.Question, userID int64, projectID int64) ([]*domains.Question, error) {
	set := utils.NewInt64Set()
	set.AddAll([]int64{96, 97, 98, 99, 100, 153, 154, 155})

	var result []*domains.Question
	// 不够 8 道直接用
...
func (q *testedQuestionGenerator) shuffle(questions []*domains.Question) {
