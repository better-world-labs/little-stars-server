...
type DonationService interface {
	...
	// ListDonation 捐献项目列表
	ListDonation(query page.Query) ([]*entities.Donation, error)

	// ListDonatorsDonation 根据捐献者查询捐献项目列表
	ListDonatorsDonation(userId int64) ([]*entities.DonationWithUserDonated, error)
