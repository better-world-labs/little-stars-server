module aed-api-server

go 1.18

require (
	github.com/aliyun/alibaba-cloud-sdk-go v1.61.1399
...
require (
	...
	github.com/FISCO-BCOS/go-sdk v0.11.0 // indirect
...
require (
	...
	gitlab.openviewtech.com/openview-pub/gopkg v1.7.21
